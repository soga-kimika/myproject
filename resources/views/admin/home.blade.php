    ...
    <div class="row justify-content-center text-center">
        ...
        <div class="col-auto">
            <a href="{{ route('admin.galleries.index') }}" title="ギャラリー管理" class="btn btn-link">
                <i class="fas fa-images home-icon fa-2x"></i>
                <p>Gallery</p>
            </a>
        </div>
    </div>
