                                 ...
                                 {{-- 入力フォームで選択した優先度のアイコンを表示 --}}
                                    <tr>
                                        <td class="col-priority">
                                            ...
                                            {{-- 編集ボタン モーダルトリガー--}}
                                            <td>
                                            <a href="#" class="btn  btn-edit custom-outline" data-toggle="modal" data-target="#editModal{{ $item2->id }}" data-request="{{ $item2->request_message }}" data-priority="{{ $item2->priority }}"><i class="fas fa-edit"></i></a>
                                        </td>   
                                            <td >
