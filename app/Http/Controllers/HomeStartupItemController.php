...
class HomeStartupItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('imageUpload')) {
            ...
            $homeStartupItem->image_url = 'data:image/jpeg;base64,' . $binary_image;
            $homeStartupItem->image_name = pathinfo($request->file('imageUpload')->getClientOriginalName(), PATHINFO_FILENAME) . '_' . date('Ymd_His') . '.' . $request->file('imageUpload')->getClientOriginalExtension();
        }
